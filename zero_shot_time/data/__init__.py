...
def get_dataset(
    dataset_name: str, sub_category=None, path=None
) -> tp.Tuple[tp.Union[datasets.Dataset, np.array], tp.Optional[str]]:
    ...
    if dataset_name == "darts" and sub_category is not None:
        data_lookup = {"beer": ds.AusBeerDataset, "airpassenger": ds.AirPassengersDataset}
